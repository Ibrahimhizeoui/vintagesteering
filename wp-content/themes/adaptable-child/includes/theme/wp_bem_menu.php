...
class walker_texas_ranger extends Walker_Nav_Menu {
    ...
    function __construct($css_class_prefix, $dropdown) {
...
function bem_menu($location = "main_menu", $css_class_prefix = 'main-menu', $css_class_modifiers = null, $dropdown = false){
    ...
    $args = array(
        ...
        'walker'            => new walker_texas_ranger($css_class_prefix, $dropdown)
    );
