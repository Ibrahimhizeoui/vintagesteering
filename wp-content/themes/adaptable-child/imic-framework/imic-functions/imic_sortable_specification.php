...
if ( !function_exists( 'imic_sortable_specification' ) )
{
    function imic_sortable_specification( )
    {
        ...
        if ( !empty( $vals ) )
        {
            ...
            echo '<select id="' . $select_new_class . ( ( $spec_id * 111 ) + 2648 ) . '" class="form-control selectpicker custom-cars-fields mandatory" name="' . ( $spec_name ) . '" data-default-field-name="' . esc_attr__( 'All', 'framework' ) . '">';
