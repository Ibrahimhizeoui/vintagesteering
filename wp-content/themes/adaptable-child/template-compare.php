  	...
  	<div class="main" role="main">
    	<div id="content" class="content full">
			<?php if(!empty($compare)) { ?>
                    ...
                    <div class="col3 comparision-table">
                            ...
                            <div class="container">
                                ...
                                <?php foreach($compare as $comp)
                                {
                                    ...
                                    { ?>
                                        <div class="comp-table-col">
                                            <strong><?php echo esc_attr($highlighted_specs_val); ?></strong>
                                            <span class="price"><?php echo __('This vehicle might be sold or not active','adaptable-child'); ?></span>
                                        </div>
                                    <?php }
                                } ?>
                            </div>
                        ...
                        <div class="container">
                        	...
                        	<div class="comp-feature-head comp-table-row">
                                <div class="comp-table-col"><?php echo esc_attr_e('Vehicle details','adaptable-child'); ?></div>
                            </div>
                        	...
                        	<div class="comp-feature-head comp-table-row">
                                <div class="comp-table-col"><?php echo esc_attr_e('Additional Options','adaptable-child'); ?></div>
                            </div>
                            ...
                            <div class="comp-table-row comp-table-permalinks">
                                ...
                                <?php foreach($compare as $comp) {
        							$completed = get_post_meta($comp,'imic_plugin_ad_payment_status',true);
        							if($completed==1) {  ?>
                                <div class="comp-table-col"><a href="<?php echo esc_url(get_permalink($comp)); ?>" class="btn btn-primary btn-lg"><?php echo esc_attr_e('View listing','adaptable-child'); ?></a></div><?php } else { ?>
        							<div class="comp-table-col"></div>
        						<?php } } ?>
                            </div>
                        </div>
                ...
                <?php } else { echo '<h2>'.__('You have not selected any listing to compare.','framework').'</h2>'; } ?>
            </div>
   	    </div>
    <!-- End Body Content -->
<?php } else { ?>
