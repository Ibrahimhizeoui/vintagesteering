    ...
    jQuery(document).ready(function($) {
        $('form#reset-pass').on('submit', function(e) {
            if ($('form#reset-pass #reset-email').val() == '') {
                ...
                $('form#reset-pass p.status').show().html("<div id=\"messages\"><div class=\"alert alert-error\">" + reset_password.fillemail + "</div></div>");
            } else {
                $('form#reset-pass p.status').show().html();
                $('form#reset-pass p.status').show().html("<div id=\"messages\"><div class=\"alert alert-success\">" + ajax_login_object.loadingmessage + "</div></div>");
            }
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.passauth == false) {
                        $('form#reset-pass p.status').show().html();
                        $('form#reset-pass p.status').show().html("<div id=\"messages\"><div class=\"alert alert-error\">" + data.message + "</div></div>");
                    }
                    if (data.passauth == true) {
                        $('form#reset-pass p.status').show().html();
                        $('form#reset-pass p.status').show().html("<div id=\"messages\"><div class=\"alert alert-success\">" + data.message + "</div></div>");
                    }
        ...
        $('form#login').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    $('form#login p.status').html("<div class=\"input-group\"><div id=\"messages\"><div class=\"alert alert-error\">" + data.message + "</div></div></div>");
        ...
        $('form#login-popup').on('submit', function(e) {
            $('form#login-popup p.status').show().html("<div id=\"messages\"><div class=\"alert alert-success\">" + ajax_login_object.loadingmessage + "</div></div>");
            $.ajax({
                type: 'POST',
                dataType: 'json',
                url: ajax_login_object.ajaxurl,
                ...
                success: function(data) {
                    $('form#login-popup p.status').html("<div class=\"form-group\"><div id=\"messages\"><div class=\"alert alert-error\">" + data.message + "</div></div></div>");
                    if (data.loggedin == true) {
                        $('form#login-popup p.status').html("<div id=\"messages\"><div class=\"alert alert-success\">" + data.message + "</div></div>");
                        document.location.href = jQuery('.redirect_login').val();
                    }
                }
            });
