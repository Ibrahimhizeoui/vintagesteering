                	...
                	<ul class="utility-icons tools-bar">
                    	<li><a href="#"><i class="fa fa-star-o"></i></a>
                        	<div class="tool-box">
                                ...
                                <div class="tool-box-foot">
                                	...
                                	<a href="<?php echo esc_url(imic_get_template_url("template-compare.php")); ?>" class="button button--full compare-in-box" disabled><?php _e('Compare','framework'); ?>()</a>
                                </div>
                            </div>
                        </li>
                    	...
                    	<li><a href="#"><i class="fa fa-clock-o"></i></a>
                        	<div class="tool-box">
                                ...
                                <div class="tool-box-foot">
                                	<a href="<?php echo imic_get_template_url("template-compare.php"); ?>" class="button button--full compare-viewed-box" disabled><?php _e('Compare','framework'); ?>()</a>
                                </div>
                            </div>
                        </li>
                    </ul>
