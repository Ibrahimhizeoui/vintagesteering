...
// Countries
include(locate_template('imic-framework/class-wc-countries.php'));
...
// map array using values
$countryListMap = array_map(function($value) {
    return __($value, 'framework');
}, array_values($countryList));

// combine both arrays
$countryListCombined = array_combine($countryListMap, $countryListMap);
...
$meta_boxes[] = array(
    ...
    'fields' => array(
        ...
        array(
            'name' => __('Instagram', 'framework'),
            'id' => $prefix . 'user_instagram',
            'desc' => __('Enter Instagram URL.', 'framework'),
            'type' => 'text',
            'std' => ''
        ),
        array(
            'name' => __('Snapchat', 'framework'),
            'id' => $prefix . 'user_snapchat',
            'desc' => __('Enter Snapchat URL.', 'framework'),
            'type' => 'text',
            'std' => ''
        )
    )
...
$meta_boxes[] = array(
    ...
    'show' => array(
        ...
        'template' => array(
            'template-home.php',
            'template-home-second.php',
            'template-home-third.php'
        )
    ),
    'fields' => array(
        array(
...
$meta_boxes[] = array(
    ...
    'fields' => array(
        ...
        array(
            'name' => __('Country', 'framework'),
            'id' => $prefix . 'user_country',
            'desc' => __('User Country.', 'framework'),
            'type' => 'select',
            'options' => $countryListCombined,
            'std' => ''
        ),
        array(
